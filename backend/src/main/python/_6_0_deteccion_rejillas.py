    ...
    if 0.5 < aspect_ratio < 1.5 and 10 < w < 50 and 10 < h < 50:
        ...
        if len(approx) == 4:
            ...
            if M['m00'] != 0:
                ...
                side_width = w // 4  # Se puede ajustar segun el tamaño de la rejilla
                side_height = h
                ...
                #ACA SE ANALIZAN LOS PIXELES PARA AMBOS LADOS DE LAS VENTILACIONES
                ...
                if green_pixels_left < 500 and green_pixels_right < 500:  
                    return True

    return False

def proceso_deteccion_rejilla(image_path):
...
#Con la mascara limpia encuentro los contornos
    ...
    for contour in contours:
        if es_rejilla(contour, hsv_image, mask_clean):
            ...
            if M['m00'] != 0:
                ...
                #dibujo un circulo blanco sobre la rejilla
                cv2.circle(image, (cx, cy), 5, (255, 255, 255), -1)

 
    output_image_path = '/home/meli/planeargas/backend/src/detecciones/plano_con_rejillas.png'
    cv2.imwrite(output_image_path, image)

    output_txt_path = '/home/meli/planeargas/backend/src/detecciones/ubicacion_rejillas.txt'
