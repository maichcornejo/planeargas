...
def process_geotiff_puntos(file_path, output_file, color):
    ...
    with rasterio.open(file_path) as app:
        # Leer la imagen y la transformación affine
        image = app.read(1)  # Leer la primera banda de la imagen
...
file_path = '/home/Maia/planeargas/backend/app/imagen_raster/subidas_bajadas.tif'
color = 'blue'
# Ruta al archivo de salida
output_file = '/home/Maia/planeargas/backend/app/txt_resultantes/resultados_subidas_bajadas.txt'
