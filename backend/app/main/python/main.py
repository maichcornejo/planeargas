...
input_image_path = '/home/Maia/planeargas/backend/app/imagen_entrada/planta_1.png'
...
def main():
    ...
    artefactos = ["Artefacto1", "Artefacto2", "Artefacto3"]  # Lista de los artefactos a detectar
    detector.procesar_artefactos(img_plano, artefactos)  # Llamar al método para procesar la detección de artefactos
