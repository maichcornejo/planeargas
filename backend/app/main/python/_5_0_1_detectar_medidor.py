...
def encontrar_medidor_por_ubicacion_fija(image, resolucion):
    ...
    for contour in contours:
        ...
        if (ancho_medidor_px - tolerancia) <= w <= (ancho_medidor_px + tolerancia) and (alto_medidor_px - tolerancia) <= h <= (alto_medidor_px + tolerancia):
            ...
            cv2.imwrite('/home/Maia/planeargas/backend/app/detecciones/medidor_sin_fondo.png', medidor_sin_fondo)
    ...
    if os.path.exists(image_path):
        ...
        if image is None:
            ...
            if medidor_coordenadas:
                ...
                output_txt_path = '/home/Maia/planeargas/backend/app/detecciones/ubicacion_medidor.txt'
...
ruta = '/home/Maia/planeargas/backend/app/imagen_entrada/planta_1.png'
resolucion = 15.65
